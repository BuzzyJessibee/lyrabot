...
class LyraCommand extends commando.Command {
    constructor(client) {
        super(client, {
            name: 'ra',
            group: 'lyrautilities',
            memberName: 'ra',
            description: 'ly!ra - A help command'
        });
    }
    ...
    async run (message) {
        var image = {
                "embed": {
                  "title": "LyraBot - A piece of Lyra's soul",
                  "description": "Hi! My name is LyraBot, and I'm made by Lyra Rose!\n\nWanna see what I can do?",
                  "color": 3319968,
                  "footer": {
                    "text": "LyraBot - Made with ❤️ by Lyra Rose"
                  },
                  "thumbnail": {
                    "url": "https://cdn.discordapp.com/attachments/407363806839177216/840786541403177000/CKBcGZwUMAAVVvf.png"
                  },
                  "fields": [
                    {
                      "name": "LyraUtilities",
                      "value": "🏓 - ly!ping | Tests the bot's ping to Discord\n✨ - ly!ra | Shows this help command\n:scissors: - ly!prune | Deletes up to 99 recent (within 14 days) messages\n:athletic_shoe: - ly!kick | Kicks a user from the server\n🔨 - ly!ban | Bans a user from the server"
                    },
                    {
                      "name": "Fun Stuff",
